...
export const ru: WidgetStrings = {
  ...
  demoOwnTenantBannerNotice:
    "Это ваш собственный тенант. Опубликованный ниже логин оператора относится к общим демо-магазинам, "
  ...
  demoOwnTenantPrivacyNote:
    ...
    + "даёт доступ только к общим демо-магазинам — никогда к тенанту, на котором вы находитесь. "
